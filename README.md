...
![image](https://github.com/user-attachments/assets/a5ede38a-4c6a-40cd-a126-4e0c7296ac75)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/65b40be6-02e0-4202-b71c-35770bc0732d)


## DUTY CYCLE AND FREQUENCY CALCULATION 
FOR PULSE AT 500
![image](https://github.com/user-attachments/assets/661c1f66-3183-4071-b85a-0dab0c6f6a25)

TON = 2ms TOFF=2ms TOTAL TIME = 4ms FREQUENCY = 1/(TOTAL TIME)==1/4=250Hz

FOR PULSE AT 700
![image](https://github.com/user-attachments/assets/42f6ec06-7995-470c-940e-239742b43940)
TON = 3ms TOFF=1ms TOTAL TIME = 4ms FREQUENCY = 1/(TOTAL TIME)=1/4=250Hz

FOR PULSE AT 900
![image](https://github.com/user-attachments/assets/7ef26de3-b9b8-4ce8-880a-af808247f6b3)
